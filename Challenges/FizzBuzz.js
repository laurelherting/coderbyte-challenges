...
// Print out all the numbers from 1 to 100. For every number divisible by 3 print replace it with
// the word "Fizz", for any number divisible by 5 replace it with the word "Buzz" and for a number divisible
